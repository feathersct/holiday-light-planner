...
public interface ListingRepository extends JpaRepository<Listing, Long> {
    ...
    @Query("SELECT l FROM Listing l LEFT JOIN FETCH l.tags WHERE l.host.id = :hostId AND l.isActive = true ORDER BY l.startDatetime DESC")
    List<Listing> findActiveByHostId(@Param("hostId") Long hostId);
